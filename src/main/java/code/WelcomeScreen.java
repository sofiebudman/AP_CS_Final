...
public class WelcomeScreen {
    ...
    public void virusControlScreen(){
        ...
        cp5.addSlider("deathRateSlider")
                .setPosition(540,120)
                .setSize(200,20)
                .setRange(0,100)
                .setValue(50);

        cp5.addSlider("recoveryRateSlider")
                .setPosition(540,150)
                .setSize(200,20)
                .setRange(0,100)
                .setValue(50);

        cp5.addSlider("transmissionRateSlider")
                .setPosition(540,180)
                .setSize(200,20)
                .setRange(0,100)
                .setValue(50);

        cp5.addDropdownList("countryStart")
                .setPosition(540,210)
